...
if __name__ == "__main__":
    ...
    if _check["ok"]:
        print("[自检] DeepSeek 模型配置正常：{} @ {}".format(_check['model'], _check['base_url']))
    else:
        print("[自检] ⚠ DeepSeek 模型配置异常：{}".format(_check['issues']))
    ...
    print("  访问地址: http://127.0.0.1:5001  (debug={})".format(debug))
    print("=" * 50)
